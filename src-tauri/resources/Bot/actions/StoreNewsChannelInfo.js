...
export default class StoreNewsChannelInfo {
    static type = "Store News Channel Info"

    static title(data) {
        return `Store "${data.get("info")}" from news channel "${data.get("channel")}"`;
    }

    static variableTypes = ["News Channel", "Server", "Text", "Boolean", "Number", "Date", "List"];

    static html = `
        <div class="grid grid-cols-4 items-center gap-4">
            <dbe-label name="Channel"></dbe-label>
            <dbe-variable-list name="channel" class="col-span-3" variableType="News Channel"></dbe-variable-list>
        </div>
        <div class="grid grid-cols-4 items-center gap-4">
        ...
        <div class="grid-cols-4 items-center gap-4">
            ...
            <dbe-variable-list name="value" id="var" class="col-span-3" variableType="News Channel,Server,Text,Boolean,Number,Date,List"></dbe-variable-list>
        </div>
    `;
