    ...
    static html = `
        ...
        <template id="optionsModal">
            ...
            <div class="grid grid-cols-4 items-center gap-4">
                ...
                <dbe-select name="type" onChange="(value) => document.getElementById('var').setVariableType(value.replace('Integer', 'Number'))" values="Attachment,Boolean,Channel,Integer,Mentionable,Number,Role,Text,User" class="col-span-3"></dbe-select>
            </div>
             <div class="grid grid-cols-4 items-center gap-4">
