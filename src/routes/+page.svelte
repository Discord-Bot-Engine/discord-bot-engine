<script>
    ...
    import {PlusIcon, FolderOpenIcon, TriangleAlertIcon} from "@lucide/svelte";
    ...
    <Dialog.Content class="sm:max-w-[425px] px-4.5">
        ...
        <div class="grid gap-4 py-4">
            <div class="grid grid-cols-4 items-center gap-4">
                ...
                <Input id="name" class="col-span-3 invalid:ring-2 invalid:ring-destructive" required
                       bind:value={botName}/>
            </div>
            <div class="grid grid-cols-4 items-center gap-4">
                ...
                <div class="flex col-span-3 gap-2">
                    <Input id="path" class="flex-auto invalid:ring-2 invalid:ring-destructive" required
                           bind:value={botPath}/>
                    <Button title="Choose Folder" onclick={selectFolder}>
                        <FolderOpenIcon/>
                    </Button>
                </div>
            </div>
...
<Modal title="Missing Requirements" bind:open={App.showWarning} onDone={() => App.showWarning = false}
       showCancel={false}>
    <div class="flex flex-col gap-4 py-4 px-1 w-full">
        {#if !App.hasNode}
